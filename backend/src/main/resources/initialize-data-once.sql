-- Manual data initialization script - Run this ONCE only
-- This script will only insert data if the tables are empty
...
-- Insert sample leads only if the leads table is empty
INSERT IGNORE INTO leads (id, name, email, phone, city, service_id, budget, status, source, created_at, updated_at) VALUES
(1, 'Priya Sharma', 'priya@email.com', '9876543210', 'Mumbai', 1, 45000.00, 'NEW', 'WEBSITE', NOW(), NOW()),
(2, 'Rajesh Kumar', 'rajesh@email.com', '9876543211', 'Delhi', 2, 75000.00, 'NEW', 'INSTAGRAM', NOW(), NOW()),
(3, 'Anjali Patel', 'anjali@email.com', '9876543212', 'Bangalore', 3, 120000.00, 'NEW', 'REFERRAL', NOW(), NOW()),
(4, 'Vikram Singh', 'vikram@email.com', '9876543213', 'Pune', 4, 200000.00, 'NEW', 'WHATSAPP', NOW(), NOW());

-- Insert sample deals only if the deals table is empty
INSERT IGNORE INTO deals (id, lead_id, title, stage, value, probability, created_at, updated_at) VALUES
